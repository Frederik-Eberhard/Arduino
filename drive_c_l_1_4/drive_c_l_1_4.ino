...
long getDir(int a){ 
  ...
  if(a > 90)                  //links
    i2 = constrain((255 - (pow(a-90,2) * 51 / 290)),-255,255)/2;
  else
    i3 = constrain((255 - (pow(a-90,2) * 51 / 290)),-255,255)/2;
...
void  showDisplay(int data, int s1, int s2, int dir){
  switch(dir){
