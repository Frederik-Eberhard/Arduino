...
const int m_a1 = 8;    //motor A signal 1
const int m_a2 = 9;    //motor A signal 2
const int m_a  = 12;    //motor A speed
const int m_b1 = 10;    //motor B signal 1
const int m_b2 = 11;    //motor B signal 2
const int m_b  = 13;    //motor B speed
